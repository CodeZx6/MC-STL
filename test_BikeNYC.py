...
from models.model_ALL_B import MC_STL
sys.path.append('.')
...
parser.add_argument('--img_height', type=int, default=8, help='image height')
...
parser.add_argument('--dataset', type=str, default='BikeNYC', help='which dataset to use')
...
test_dataloader, max_min= get_dataloader_Bike(datapath, opt.batch_size, 'test')
